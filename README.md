...
My QEMU fork that I mess with because why not.
...
This version of QEMU is only ment to be built on Linux, other operating systems may work but are untested. Here are the steps to build QEMU:
